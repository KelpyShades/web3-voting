...
export default async function Home() {
  ...
  return (
    <div className="flex min-h-screen w-screen flex-col items-center justify-items-center overflow-hidden">
      {/* nav bar */}
